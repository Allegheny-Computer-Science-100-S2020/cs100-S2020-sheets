...
\newcommand{\assignmentassignedate}{February 27}
...
with a name like
``Allegheny-Computer-Science-100-Spring-2020/computer-science-100-spring-2020-lab-6-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-100-S2020/computer-science-100-spring-2020-lab-6-gkapfham.git
\end{lstlisting}
...
% \marginnote{\caution{Modify DNA strings}}[2.0in]
...
\begin{verbatim}
Gregory M. Kapfhammer Thu Feb 27 10:19:43 EDT 2020
...
\begin{verbatim}
Gregory M. Kapfhammer Thu Feb 27 10:19:53 EDT 2020
Okay, I am going to manipulate the DNA string "actg".
...
\gradlerun{} in the Docker container---this is the ``execute'' step that will run
...
\item Before you start to implement your Java program, take the time to
  carefully review the examples in this assignment sheet, making sure that you
  understand each step and its output.

\item You are likely to encounter challenges as you attempt to define a correct
  strategy for substituting one character in a DNA string with another. Make
  sure that you work through several examples and develop a general-purpose
  implementation strategy before you start coding your solution. You can
  ask the course instructor or a technical leader to check your solution.
...
\item If you would like to do so, please consider how to divide the
  computational work completed by your program into separate methods that are
...
\item Since your program employs randomization, every run will not always make
  the same output.
...
\item Stored in \reflection{}, a multiple-paragraph reflection on the commands
  ...
  % explain your strategy for manipulating the DNA {\tt String} variable.
