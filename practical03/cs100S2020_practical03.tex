...
\newcommand{\assignmentduedate}{February 3}
...
\newcommand{\mainprogramsource}{\lstinline{src/main/java/practicalthree/ComputeMoonDistance.java}}
...
\newcommand{\gitcommitmainprogram}{\command{git commit src/main/java/practicalthree/ComputeMoonDistance.java -m "Your
descriptive message about the defect that you fixed"}}
...
desktop''. You will continue to practice using Slack to support communication
...
errors that may arise when variables have the wrong types.
...
Chapters 1 and 2 in the course textbook, ensuring that you fully understand all
of the concepts that we discussed during class and investigated during prior
practical and laboratory sessions. Please see the instructor or one of the
technical leaders if you have questions these reading assignments.

\section*{Finding and Fixing Defects in Programs}
...
like
``Allegheny-Computer-Science-100-Spring-2020/computer-science-100-spring-2020-practical-3-gkapfham''.
...
of output that your program should produce. Note that the provided source code
contains defects in it! You are responsible for finding and fixing all of these
defects. Once you locate and resolve one of these issues, please put a comment
into the code to explain the problem that you found and the way in which you
decided to handle it. As you complete this practical assignment, make sure that
you regularly commit your code to GitHub and use descriptive messages that say
what you fixed. Here are some questions about Java programming that should help
you think about potential defects:
...
\begin{enumerate}
  ...
  \item What is the full name of the \command{main} method in a Java program?
...
transferring your source code to GitHub did not work correctly, then try to
determine why, asking a technical leader or the course instructor for
...
your submission does not meet the requirements, then a red \naughtmark{} will
...
and you will earn full credit. Unless you provide the course instructor with
...
\noindent This assignment invites you to submit, using GitHub, the following
deliverable. Because this is a practical assignment, you are not required to
complete any technical writing.
...
\item A properly documented, well-formatted, and correct version of
  ...
  produces the desired output. In addition to your Java source code no longer
  containing any defects that ``break the build'', it should feature additional
  comments that explain each of the mistakes that you found and a clear
  statement of the process you followed to find and fix them. As you fix
  defects, make sure that your incrementally commit your work to your GitHub
  repository!
