...
window and type the command \command{mkdir cs100S2020}. To enter into this
directory you should now type \command{cd cs100S2020}. Next, you can type the
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-100-S2020/computer-science-100-spring-2020-lab-1-gkapfham.git
\end{lstlisting}
