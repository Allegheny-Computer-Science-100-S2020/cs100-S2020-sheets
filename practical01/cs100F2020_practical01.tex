...
\begin{enumerate}
    ...
    \item Determine the version of your operating system. If your laptop meets
      ...
      \url{https://docs.docker.com/toolbox/toolbox_install_windows/}. Please
      note that the Department of Computer Science at Allegheny College
      officially supports the use of Docker only on Windows 10 Pro, Windows 10
      Enterprise, MacOS, and Linux. All other operating systems (e.g., Chrome
      OS, Windows 7, Windows 8, or Windows 10 Home) are not officially supported
      and may not work reliably with Docker Toolbox. In summary, here are the
...
\section*{Summary of Common Challenges}

\section*{Mastery Questions to Answer in Slack}
